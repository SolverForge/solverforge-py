...
is `0.6.5`, targeting the six SolverForge `0.19.3` registry crates and
`solverforge-ui` `0.7.0`; `make release-base-check` must stay green. The
`Makefile` owns local release targets,
